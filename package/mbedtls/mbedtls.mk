...
# install currently does not know about DESTDIR
# https://github.com/Mbed-TLS/mbedtls/issues/10627
# recommends the use of --prefic instead
define MBEDTLS_INSTALL_STAGING_CMDS
	$(TARGET_MAKE_ENV) $(MBEDTLS_BUILD_ENV) $(BR2_CMAKE) --install $(@D) --prefix $(STAGING_DIR)
endef

define MBEDTLS_INSTALL_TARGET_CMDS
	$(TARGET_MAKE_ENV) $(MBEDTLS_BUILD_ENV) $(BR2_CMAKE) --install $(@D) --prefix $(TARGET_DIR)
endef
